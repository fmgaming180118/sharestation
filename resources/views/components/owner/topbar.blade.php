        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-6">
                ...
                <nav class="hidden md:flex items-center gap-6">
                    <a href="{{ route('owner.dashboard') }}" class="flex items-center gap-2 text-white hover:text-white/80 transition">
                ...
                <div class="relative" id="profileDropdown">
                    <button onclick="toggleProfileDropdown()" class="flex items-center gap-3 hover:opacity-90 transition">
                        ...
                        <div class="hidden lg:block">
                            ...
                            <p class="text-white/80 text-xs capitalize">{{ auth()->user()->role ?? 'Pemilik' }}</p>
                        </div>
                    ...
                    <div id="dropdownMenu" class="hidden absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-2xl overflow-hidden z-[10000] border border-gray-100">
                        <div class="py-2">
                            <!-- Profile Option -->
                            <a href="{{ route('owner.profile') }}" class="flex items-center gap-3 px-4 py-3 hover:bg-purple-50 transition group">
