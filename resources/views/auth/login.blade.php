...
<head>
    ...
    <title>Login - Share Station</title>
    ...
    <div class="w-full max-w-md mx-4">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-[#7b9ec9] to-[#8ba8d4] px-8 py-10 text-center">
                ...
                <p class="text-white/90 text-sm font-medium">User Login Portal</p>
            </div>
            ...
            <div class="px-8 py-10">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-500 text-sm">Login to find charging station</p>
                </div>
                ...
                <form method="POST" action="{{ route('login.submit') }}" class="space-y-6">
                    ...
                    <div class="flex items-center">
                        <input 
                            ...
                            id="remember" 
                            name="remember"
                            class="w-4 h-4 text-[#7b9ec9] border-gray-300 rounded focus:ring-[#7b9ec9]"
                        >
            ...
            <div class="bg-gray-50 px-8 py-4 text-center border-t border-gray-100">
                <p class="text-sm text-gray-600">
                    Belum punya akun? 
                    <a href="{{ route('register') }}" class="text-[#7b9ec9] font-semibold hover:text-[#6b8eb9] transition">
                        Sign up
                    </a>
                </p>
            </div>
